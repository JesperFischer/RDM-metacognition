...
```{r,fig.height=6, fig.width=8, out.width="6in", out.height="4.5in", message=F,error=F,warning=F}
# 
...
knitr::include_graphics(here::here("Preregistration","Figures","parameter_comparison_plot.PNG"))
...
```{r,fig.height=6, fig.width=8, out.width="6in", out.height="4.5in", message=F,error=F,warning=F}
knitr::include_graphics(here::here("Preregistration","Figures","Pilot_predictive_checks.PNG"))
```
...
```{r,fig.height=7, fig.width=14, out.width="6.5in", out.height="4.875in", message=F,error=F,warning=F}
knitr::include_graphics(here::here("Preregistration","Figures","parameterrecovery_hier.PNG"))
```
...
```{r, fig.height=8, fig.width=12, out.width="6.5in", out.height="4.333in", warning=F,error=F,message=F}
knitr::include_graphics(here::here("Preregistration","Figures","sequential_samping_plot.PNG"))
```
