...
# plate_tex_path <- here::here("Preregistration", "Figure scripts", "Platenotations", "platenotation.tex")
# plate_pdf_path <- here::here("Preregistration", "Figure scripts", "Platenotations", "platenotation.pdf")

# invisible(tinytex::latexmk(plate_tex_path))

# Clean up latex sidecar files that can appear in the project root during render.
# invisible(file.remove(here::here("Preregistration", "platenotation.log")))

# For PDF output, include the PDF directly; for HTML/Word, convert to image
if (knitr::is_latex_output()) {
  plate_figure_path <-  here::here("Preregistration", "Figure scripts", "Platenotations", "platenotation.pdf")
} else {
