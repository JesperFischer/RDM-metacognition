...
fit_model_hier = function(dd,
  ...
  fit$save_object(here::here("Sequential sampling","Fits","Hierarchical","Hierarchical_30.rds"))
...
fit_model_hier_nolapse = function(dd,
  ...
  # fit$save_object(here::here("Sequential sampling","Fits","Hierarchical","Hierarchical_nolapse_25.rds"))
...
fit_model_hier_nolapse_camped = function(dd,
  ...
  fit$save_object(here::here("Sequential sampling","Fits","Hierarchical","Hierarchical_nolapse_35_clamped.rds"))
