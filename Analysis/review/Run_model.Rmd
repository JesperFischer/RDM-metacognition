...
ggsave(here::here("binned_plot.tiff"),plots[[3]],dpi = 300,width = 30, height = 18, units = "cm")
...
```{r,fig.height=8,fig.width=12}
plots = Plot_group_predictive_psycho_nbin(predictions,df,ACC = F,n_bins = NULL)
plots[[3]]

ggsave(here::here("plot_all.tiff"),plots[[3]],dpi = 300,width = 30, height = 18, units = "cm")
