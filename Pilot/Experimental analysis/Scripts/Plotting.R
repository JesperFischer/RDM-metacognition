...
prelim_ss_plot = function(df,name){
  fit1 <- readRDS(here::here("Pilot","Savedmodels",paste0("fit1_",name,".rds")))
  fit2 <- readRDS(here::here("Pilot","Savedmodels",paste0("fit2_",name,".rds")))
  fit3 <- readRDS(here::here("Pilot","Savedmodels",paste0("fit3_",name,".rds")))
