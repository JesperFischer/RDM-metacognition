...
folder = here::here("Pilot","Data","pilots","Jesper_2025_17_12")
...
testdata = read.csv(grep(here::here("Pilot","Data","pilots","Jesper_2025_17_12","RDM_reportz_sub5.csv"),
...
write.csv(qq,here::here("Pilot","Data","pilots","Jesper_2025_17_12","full_jespere_data.csv"))
